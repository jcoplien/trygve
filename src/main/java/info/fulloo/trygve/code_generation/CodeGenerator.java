...
public interface CodeGenerator {
	...
	public List<RTCode> compileIdentityBooleanExpression(IdentityBooleanExpression expr, MethodDeclaration methodDeclaration, RTType rtTypeDeclaration, StaticScope scope);
	...
	public List<RTCode> compileInternalAssignmentExpression(InternalAssignmentExpression expr, MethodDeclaration methodDeclaration, RTType rtTypeDeclaration, StaticScope scope);
