...
public class KantParser extends Parser {
	...
	public static final int
		...
		STRING=33, INTEGER=34, FLOAT=35, BOOLEAN=36, SWITCH=37, CASE=38, DEFAULT=39, 
		BREAK=40, CONTINUE=41, RETURN=42, REQUIRES=43, NEW=44, CLONE=45, NULL=46, 
		CONST=47, LOGICAL_NOT=48, POW=49, BOOLEAN_SUMOP=50, BOOLEAN_MULOP=51, 
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'private'", "'char'", "'interface'", "'!='", "'class'", 
		"'while'", "';'", "'{'", "'extends'", "'}'", "'for'", "'if'", "'<='", 
		"'role'", "'double'", "'int'", "'do'", "'('", "'context'", "','", "'.'", 
		"'implements'", "':'", "'>='", "'['", "'=='", "'String'", "'public'", 
		"']'", "'stageprop'", "'else'", "')'", "STRING", "INTEGER", "FLOAT", "BOOLEAN", 
		"'switch'", "'case'", "'default'", "'break'", "'continue'", "'return'", 
		"'requires'", "'new'", "'clone'", "'null'", "'const'", "LOGICAL_NOT", 
		"'**'", "BOOLEAN_SUMOP", "'&&'", "ABELIAN_SUMOP", "ABELIAN_MULOP", "'-'", 
		"'+'", "'<'", "'>'", "LOGICAL_NEGATION", "ABELIAN_INCREMENT_OP", "JAVA_ID", 
		"INLINE_COMMENT", "C_COMMENT", "WHITESPACE", "'='"
	};
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(102); type_declaration_list(0);
				setState(103); main();
				}
				break;
			case 2:
				...
				{
				setState(105); type_declaration_list(0);
				}
				break;
			}
		}
	...
	public final Type_declarationContext type_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(123); match(JAVA_ID);
				setState(124); match(T__24);
				setState(125); context_body(0);
			...
			case 2:
				...
				setState(129); match(JAVA_ID);
				setState(130); type_parameters();
				setState(134);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__10) {
					{
					{
					setState(131); implements_list(0);
					}
					}
					setState(136);
					_errHandler.sync(this);
			...
			case 3:
				...
				setState(142); match(JAVA_ID);
				setState(143); type_parameters();
				setState(144); match(T__23);
				setState(145); match(JAVA_ID);
				setState(149);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__10) {
					{
					{
					setState(146); implements_list(0);
					}
					}
					setState(151);
					_errHandler.sync(this);
			...
			case 4:
				...
				while (_la==T__10) {
					{
					{
					setState(158); implements_list(0);
					}
					}
					setState(163);
					_errHandler.sync(this);
			...
			case 5:
				...
				setState(169); match(JAVA_ID);
				setState(170); match(T__23);
				setState(171); match(JAVA_ID);
				setState(175);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__10) {
					{
					{
					setState(172); implements_list(0);
					}
					}
					setState(177);
					_errHandler.sync(this);
				...
				setState(179); class_body(0);
				setState(180); match(T__22);
				}
				break;
			case 6:
				...
				while (_la==T__10) {
					{
					{
					setState(184); implements_list(0);
					}
					}
					setState(189);
					_errHandler.sync(this);
				...
				setState(191); match(JAVA_ID);
				setState(192); match(T__24);
				setState(193); class_body(0);
			...
			case 7:
				...
				setState(197); match(JAVA_ID);
				setState(198); match(T__24);
				setState(199); interface_body(0);
	...
	public final Type_parametersContext type_parameters() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(216); match(LT);
			setState(217); type_parameter();
			setState(222);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__12) {
	...
	public final Type_parameterContext type_parameter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(238); type_name();
			setState(241);
			_la = _input.LA(1);
			if (_la==T__23) {
				{
				setState(239); match(T__23);
				setState(240); type_name();
				}
			}
	...
	private Context_bodyContext context_body(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(244); context_body_element();
				}
				break;
			case 2:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(249); context_body_element();
					}
					} 
				}
				setState(254);
	...
	public final Context_body_elementContext context_body_element() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(255); method_decl();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(256); object_decl();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(257); role_decl();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(258); stageprop_decl();
				}
				break;
			}
		}
	...
	public final Role_declContext role_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(262); role_vec_modifier();
				setState(263); match(JAVA_ID);
				setState(264); match(T__24);
				setState(265); role_body(0);
			...
			case 2:
				...
				setState(269); role_vec_modifier();
				setState(270); match(JAVA_ID);
				setState(271); match(T__24);
				setState(272); role_body(0);
				setState(273); match(T__22);
				setState(274); match(REQUIRES);
				setState(275); match(T__24);
				setState(276); self_methods(0);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(279); access_qualifier();
				setState(280); match(T__18);
				setState(281); role_vec_modifier();
				setState(282); match(JAVA_ID);
				setState(283); match(T__24);
				setState(284); role_body(0);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(287); access_qualifier();
				setState(288); match(T__18);
				setState(289); role_vec_modifier();
				setState(290); match(JAVA_ID);
				setState(291); match(T__24);
				setState(292); role_body(0);
				setState(293); match(T__22);
				setState(294); match(REQUIRES);
				setState(295); match(T__24);
				setState(296); self_methods(0);
	...
	private Role_bodyContext role_body(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(307); method_decl();
				}
				break;
			case 2:
				{
				setState(308); object_decl();
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
	...
	public final Stageprop_declContext stageprop_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(334); role_vec_modifier();
				setState(335); match(JAVA_ID);
				setState(336); match(T__24);
				setState(337); stageprop_body(0);
			...
			case 2:
				...
				setState(341); role_vec_modifier();
				setState(342); match(JAVA_ID);
				setState(343); match(T__24);
				setState(344); stageprop_body(0);
				setState(345); match(T__22);
				setState(346); match(REQUIRES);
				setState(347); match(T__24);
				setState(348); self_methods(0);
				setState(349); match(T__22);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(351); access_qualifier();
				setState(352); match(T__2);
				setState(353); role_vec_modifier();
				setState(354); match(JAVA_ID);
				setState(355); match(T__24);
				setState(356); role_body(0);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(359); access_qualifier();
				setState(360); match(T__2);
				setState(361); role_vec_modifier();
				setState(362); match(JAVA_ID);
				setState(363); match(T__24);
				setState(364); role_body(0);
				setState(365); match(T__22);
				setState(366); match(REQUIRES);
				setState(367); match(T__24);
				setState(368); self_methods(0);
	...
	private Stageprop_bodyContext stageprop_body(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(374); method_decl();
				}
				break;
			case 2:
				{
				setState(375); object_decl();
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
	...
	private Class_bodyContext class_body(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(388); class_body_element();
				}
				break;
			case 2:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(392);
					if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
					setState(393); class_body_element();
					}
					} 
				}
				setState(398);
	...
	public final Class_body_elementContext class_body_element() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(399); method_decl();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(400); object_decl();
				}
				break;
			}
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(406);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(407); match(T__25);
						setState(408); method_signature();
						}
						break;
					case 2:
						{
	...
	public final Method_declContext method_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(416); method_decl_hook();
			setState(417); match(T__24);
			setState(418); expr_and_decl_list(0);
	...
	public final Method_signatureContext method_signature() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(423); access_qualifier();
				setState(424); return_type();
				setState(425); method_name();
				setState(426); match(T__14);
				setState(427); param_list(0);
				setState(428); match(T__0);
				setState(432);
				_errHandler.sync(this);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(435); access_qualifier();
				setState(436); return_type();
				setState(437); method_name();
				setState(441);
				_errHandler.sync(this);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(444); access_qualifier();
				setState(445); method_name();
				setState(446); match(T__14);
				setState(447); param_list(0);
	...
	public final Access_qualifierContext access_qualifier() throws RecognitionException {
		...
		try {
			...
			case T__4:
				enterOuterAlt(_localctx, 1);
				{
				setState(483); match(T__4);
				}
				break;
			case T__31:
				enterOuterAlt(_localctx, 2);
				{
				setState(484); match(T__31);
				}
				break;
			case T__30:
			case T__18:
	...
	public final Object_declContext object_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(488); access_qualifier();
				setState(489); compound_type_name();
				setState(490); identifier_list(0);
				setState(491); match(T__25);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(493); access_qualifier();
				setState(494); compound_type_name();
				setState(495); identifier_list(0);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(497); compound_type_name();
				setState(498); identifier_list(0);
				setState(499); match(T__25);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(501); compound_type_name();
				setState(502); identifier_list(0);
				}
				break;
			}
		}
	...
	public final Trivial_object_declContext trivial_object_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(506); compound_type_name();
			setState(507); match(JAVA_ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Compound_type_nameContext compound_type_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(510); match(T__7);
				setState(511); match(T__3);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(513); type_name();
				}
				break;
			}
		}
	...
	public final Type_nameContext type_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(516); match(JAVA_ID);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(517); match(JAVA_ID);
				setState(518); type_list();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(519); match(T__16);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(520); match(T__17);
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(521); match(T__30);
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(522); match(T__5);
				}
				break;
			}
		}
	...
	private Identifier_listContext identifier_list(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(526); match(JAVA_ID);
				}
				break;
			case 2:
				{
				setState(527); match(JAVA_ID);
				setState(528); match(ASSIGN);
				setState(529); expr();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(532);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(533); match(T__12);
						setState(534); match(JAVA_ID);
						}
						break;
					case 2:
						{
						...
						setState(537); match(JAVA_ID);
						setState(538); match(ASSIGN);
						setState(539); expr();
						}
						break;
					}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(550);
					if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
					setState(551); match(T__12);
					setState(552); param_decl();
					}
					} 
				}
				setState(557);
	...
	public final Param_declContext param_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(558); compound_type_name();
			setState(559); match(JAVA_ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(561); abelian_expr(0);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(562); boolean_expr(0);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(564); if_expr();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(565); for_expr();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(566); while_expr();
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(567); do_while_expr();
				}
				break;
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(568); switch_expr();
				}
				break;
			case 9:
				enterOuterAlt(_localctx, 9);
				{
				setState(569); match(BREAK);
				}
				break;
			case 10:
				enterOuterAlt(_localctx, 10);
				{
				setState(570); match(CONTINUE);
				}
				break;
			case 11:
				enterOuterAlt(_localctx, 11);
				{
				setState(571); match(RETURN);
				setState(572); expr();
				}
				break;
			case 12:
	...
	private Abelian_exprContext abelian_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(577); abelian_product(0);
			setState(582);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(578); match(ABELIAN_SUMOP);
					setState(579); abelian_product(0);
					}
					} 
				}
				setState(584);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__28) | (1L << T__19) | (1L << T__8) | (1L << T__6) | (1L << LT) | (1L << GT))) != 0)) ) {
							((Abelian_exprContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(587); abelian_expr(3);
						}
						break;
					case 2:
						{
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(598); match(ABELIAN_MULOP);
					setState(599); abelian_unary_op();
					}
					} 
				}
				setState(604);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(605);
					if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
					setState(606); match(POW);
					setState(607); abelian_atom(0);
					}
					} 
				}
				setState(612);
	...
	public final Abelian_unary_opContext abelian_unary_op() throws RecognitionException {
		...
		try {
			...
			case ABELIAN_SUMOP:
				enterOuterAlt(_localctx, 1);
				{
				setState(613); match(ABELIAN_SUMOP);
				setState(614); abelian_atom(0);
				}
				break;
			case LOGICAL_NEGATION:
				enterOuterAlt(_localctx, 2);
				{
				setState(615); match(LOGICAL_NEGATION);
				setState(616); abelian_atom(0);
				}
				break;
			case T__14:
			case STRING:
	...
	private Abelian_atomContext abelian_atom(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(621); match(ABELIAN_INCREMENT_OP);
				setState(622); abelian_atom(10);
				}
				break;
			case 2:
				{
				setState(623); match(NEW);
				setState(624); message();
				}
				break;
			case 3:
				{
				setState(625); match(NEW);
				setState(626); type_name();
				setState(627); match(T__7);
				setState(628); expr();
				setState(629); match(T__3);
				}
				break;
			case 4:
				{
				setState(631); match(NEW);
				setState(632); match(JAVA_ID);
				setState(633); type_list();
				setState(634); match(T__14);
				setState(635); argument_list(0);
				setState(636); match(T__0);
				}
				break;
			case 5:
				{
				setState(638); null_expr();
				}
				break;
			case 6:
				{
				setState(639); message();
				}
				break;
			case 7:
				{
				setState(640); match(JAVA_ID);
				}
				break;
			case 8:
				{
				setState(641); constant();
				}
				break;
			case 9:
				{
				setState(642); match(T__14);
				setState(643); abelian_expr(0);
				setState(644); match(T__0);
				}
				break;
			case 10:
				{
				setState(646); match(ABELIAN_INCREMENT_OP);
				setState(647); expr();
				setState(648); match(T__7);
				setState(649); expr();
				setState(650); match(T__3);
				}
				break;
			case 11:
				{
				setState(652); match(ABELIAN_INCREMENT_OP);
				setState(653); expr();
				setState(654); match(T__11);
				setState(655); match(JAVA_ID);
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(660); match(T__11);
						setState(661); message();
						}
						break;
					case 2:
						{
						...
						setState(663); match(T__11);
						setState(664); match(JAVA_ID);
						}
						break;
					case 3:
						{
						...
						setState(666); match(ABELIAN_INCREMENT_OP);
						}
						break;
					case 4:
						{
						...
						setState(668); match(T__7);
						setState(669); expr();
						setState(670); match(T__3);
						}
						break;
					case 5:
						{
						...
						setState(673); match(T__7);
						setState(674); expr();
						setState(675); match(T__3);
						setState(676); match(ABELIAN_INCREMENT_OP);
						}
						break;
					case 6:
						{
						...
						setState(680); match(JAVA_ID);
						setState(681); match(ABELIAN_INCREMENT_OP);
						}
						break;
					case 7:
						{
						...
						setState(682);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(683); match(T__11);
						setState(684); match(CLONE);
						}
						break;
					case 8:
						{
						...
						setState(685);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(686); match(T__11);
						setState(687); match(CLONE);
						setState(688); match(T__14);
						setState(689); match(T__0);
						}
						break;
					}
					} 
	...
	public final MessageContext message() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(695); match(JAVA_ID);
			setState(696); match(T__14);
			setState(697); argument_list(0);
	...
	private Boolean_exprContext boolean_expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(701); constant();
				}
				break;
			case 2:
				{
				setState(702); abelian_expr(0);
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(705);
						if (!(precpred(_ctx, 4))) throw new FailedPredicateException(this, "precpred(_ctx, 4)");
						setState(706); match(BOOLEAN_MULOP);
						setState(707); expr();
						}
						break;
					case 2:
						...
						setState(708);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(709); match(BOOLEAN_SUMOP);
						setState(710); expr();
						}
						break;
					}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(717); expr_and_decl_list(0);
				setState(718); match(T__22);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	public final If_exprContext if_expr() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(734); match(T__20);
				setState(735); match(T__14);
				setState(736); expr();
				setState(737); match(T__0);
				setState(738); expr();
				setState(739); match(T__1);
				setState(740); expr();
				}
				break;
			}
	...
	public final For_exprContext for_expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(744); match(T__21);
				setState(745); match(T__14);
				setState(746); expr();
				setState(747); match(T__25);
				setState(748); expr();
				setState(749); match(T__25);
				setState(750); expr();
				setState(751); match(T__0);
				setState(752); expr();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(754); match(T__21);
				setState(755); match(T__14);
				setState(756); object_decl();
				setState(757); expr();
				setState(758); match(T__25);
				setState(759); expr();
				setState(760); match(T__0);
				setState(761); expr();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(763); match(T__21);
				setState(764); match(T__14);
				setState(765); match(JAVA_ID);
				setState(766); match(T__9);
				setState(767); expr();
				setState(768); match(T__0);
				setState(769); expr();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(771); match(T__21);
				setState(772); match(T__14);
				setState(773); trivial_object_decl();
				setState(774); match(T__9);
				setState(775); expr();
				setState(776); match(T__0);
				setState(777); expr();
				}
				break;
			}
	...
	public final While_exprContext while_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(781); match(T__26);
			setState(782); match(T__14);
			setState(783); expr();
			setState(784); match(T__0);
			setState(785); expr();
			}
		}
		catch (RecognitionException re) {
	...
	public final Do_while_exprContext do_while_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(787); match(T__15);
			setState(788); expr();
			setState(789); match(T__26);
			setState(790); match(T__14);
			setState(791); expr();
			setState(792); match(T__0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Switch_exprContext switch_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(794); match(SWITCH);
			setState(795); match(T__14);
			setState(796); expr();
			setState(797); match(T__0);
			setState(798); match(T__24);
			setState(802);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public final Switch_bodyContext switch_body() throws RecognitionException {
		...
		try {
			...
			case CASE:
				{
				setState(807); match(CASE);
				setState(808); constant();
				}
				break;
			case DEFAULT:
				{
			...
			setState(812); match(T__9);
			setState(813); expr_and_decl_list(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 2: return type_declaration_list_sempred((Type_declaration_listContext)_localctx, predIndex);
		case 4: return implements_list_sempred((Implements_listContext)_localctx, predIndex);
		case 8: return context_body_sempred((Context_bodyContext)_localctx, predIndex);
		case 12: return role_body_sempred((Role_bodyContext)_localctx, predIndex);
		case 13: return self_methods_sempred((Self_methodsContext)_localctx, predIndex);
		case 15: return stageprop_body_sempred((Stageprop_bodyContext)_localctx, predIndex);
		case 16: return class_body_sempred((Class_bodyContext)_localctx, predIndex);
